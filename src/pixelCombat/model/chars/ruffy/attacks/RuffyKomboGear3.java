  ...
  public void process()
  {
    ...
    case 9: 
      if (getUser().isSwitcher())
      {
        ...
        this.user.getDashGatlingDust().reset(new Vector2d(this.user.pos.x + -this.user.getDir() * 2.25F, this.user.getGroundLevel()), this.user.statusLogic.isRight());
