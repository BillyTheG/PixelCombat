...
public class RuffyRunAttack2
  extends Attack
{
  private Ruffy user;
  
  public RuffyRunAttack2(Ruffy user, int id)
  {
    super(user, id);
    this.user = user;
  }
  ...
  public void process()
  {
    ...
    case 0: 
      ...
      {
        getUser().sound("/audio/ruffy_stamp_voice2.wav");
        getUser().physics.VX += getUser().getDir() * 5.0F;
  ...
  {
    getUser().sound("/audio/Ruffy_RunAttack2_hit.wav");
