 ...
 * @author bilal_000
 *
 *         This Manager contains all pictures and boxes for all projectiles
 *         within a game. Due to effectiveness and savings in memory data, any
 *         picture and box will be only load once.
 * 
 * 
 */
	...
	public static void main(String... args) {
		...
		try {
			...
			for (String file : files) {
				...
				console.println("Now, the file " + filename + " will be loaded.");

				InputStream stream1 = ProjectileManager.class
						.getResourceAsStream("/projectiles_sprites/" + filename + ".xml");
				...
				InputStream stream2 = ProjectileManager.class
						.getResourceAsStream("/projectile/boxes/" + filename + ".xml");
	...
	private void loadAll() {
		...
		try {
			...
			for (String file : files) {
				...
				console.println("Now, the file " + filename.toLowerCase() + " will be inserted in.");
				...
				InputStream boxStream = getClass().getClassLoader()
						.getResourceAsStream("projectile/boxes/" + filename + ".xml");
				;

				// InputStream stream2 =
				// getClass().getResourceAsStream("/projectile/boxes/" +
				// filename + ".xml");
			...
			e.printStackTrace();
			console.println("The file: " + path + " does not exist. Check your resources");
		}
