  ...
  extends Physics<Character>
{
  ...
  public void movement(float delta)
  {
    ...
    if ((((Character)this.pxObject).statusLogic.isKnockback()) && 
  ...
  private void makeGroundDust()
  {
    ...
    ((Character)this.pxObject).getJumpDust().reset(new Vector2d(((Character)this.pxObject).pos.x, ((Character)this.pxObject).getGroundLevel() + 0.25F), ((Character)this.pxObject).statusLogic.isRight());
